...
const (
	...
	ErrCode_UnaffordableErrCode        ErrCode = 10005
)
...
func (p ErrCode) String() string {
	...
	case ErrCode_UnaffordableErrCode:
		return "UnaffordableErrCode"
	}
	return "<UNSET>"
}
...
func ErrCodeFromString(s string) (ErrCode, error) {
	...
	case "UnaffordableErrCode":
		return ErrCode_UnaffordableErrCode, nil
	}
...
type User struct {
	...
	Keystore  string `thrift:"keystore,4" frugal:"4,default,string" json:"keystore"`
	PublicKey string `thrift:"public_key,5" frugal:"5,default,string" json:"public_key"`
}
...
func (p *User) GetPublicKey() (v string) {
	return p.PublicKey
}
...
func (p *User) SetKeystore(val string) {
	p.Keystore = val
}
func (p *User) SetPublicKey(val string) {
	p.PublicKey = val
}
...
func (p *User) writeField5(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("public_key", thrift.STRING, 5); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *User) DeepEqual(ano *User) bool {
	...
	if !p.Field4DeepEqual(ano.Keystore) {
		return false
	}
	if !p.Field5DeepEqual(ano.PublicKey) {
		return false
	}
	return true
}
...
func (p *User) Field4DeepEqual(src string) bool {
	...
	if strings.Compare(p.Keystore, src) != 0 {
		return false
	}
	return true
}
...
type CheckUserResponse struct {
	PublicKey   string    `thrift:"public_key,1" frugal:"1,default,string" json:"public_key"`
	AccountName string    `thrift:"account_name,2" frugal:"2,default,string" json:"account_name"`
...
func (p *CheckUserResponse) GetPublicKey() (v string) {
	return p.PublicKey
}

func (p *CheckUserResponse) GetAccountName() (v string) {
...
func (p *CheckUserResponse) SetPublicKey(val string) {
	p.PublicKey = val
}
func (p *CheckUserResponse) SetAccountName(val string) {
	p.AccountName = val
}
...
func (p *CheckUserResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("public_key", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.PublicKey); err != nil {
		return err
...
func (p *CheckUserResponse) Field3DeepEqual(src *BaseResp) bool {
