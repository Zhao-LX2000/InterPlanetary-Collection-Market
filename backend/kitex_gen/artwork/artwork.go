...
type BuyCollectionRequest struct {
	...
	Value    int64  `thrift:"value,6" frugal:"6,default,i64" json:"value"`
}
...
func (p *BuyCollectionRequest) GetValue() (v int64) {
	return p.Value
}
...
func (p *BuyCollectionRequest) SetValue(val int64) {
	p.Value = val
}
...
func (p *BuyCollectionRequest) ReadField6(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.Value = v
...
func (p *BuyCollectionRequest) writeField6(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("value", thrift.I64, 6); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *BuyCollectionRequest) Field6DeepEqual(src int64) bool {
