...
func _testtokenMw() []app.HandlerFunc {
	// your code...
	return []app.HandlerFunc{
		// use jwt mw
...
func _artworkMw() []app.HandlerFunc {
	// your code...
	return []app.HandlerFunc{
		// use jwt mw
		mw.JwtMiddleware.MiddlewareFunc(),
...
func _getethbalanceMw() []app.HandlerFunc {
	// your code...
	return nil
}

func _getcollectiontokenbalanceMw() []app.HandlerFunc {
	// your code...
	return nil
}
